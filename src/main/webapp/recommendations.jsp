...
<html lang="en">
	<head>
		...
		<!-- Primary Meta Tags -->
		<meta name="title" content="PrimeCart | Products Recommendation">
		...
		<title>PrimeCart | Recommendation</title>
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="container-fluid">
						...
						<div class="content" style="background: url('img/stay-tuned.png') no-repeat center center; background-size: contain; min-height: 75vh;">
						</div>
