...
<title>PrimeCart | Dashboard</title>
...
<body
	class="hold-transition light-mode layout-fixed layout-navbar-fixed layout-footer-fixed">
	<div class="wrapper">
...
<!-- 								<li><a href="#" class="theme-toggle" id="themeToggle" data-widget="dark-mode">Switch Theme</a></li> -->
		...
		<div class="theme-toggle-container">
		    <a href="#" id="themeToggle">
		        <i class="fa-solid fa-cloud-moon" id="toggleIcon"></i>
		    </a>
		</div>
